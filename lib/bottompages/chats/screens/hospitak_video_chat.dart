...
class HospitalVideoCall extends StatefulWidget {
  String callingId;
  String paitientname;
  HospitalVideoCall(
  ...
  @override
  State<HospitalVideoCall> createState() => _HospitalVideoCallState();
}

class _HospitalVideoCallState extends State<HospitalVideoCall> {

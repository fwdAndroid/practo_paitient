...
class HospitalPastChatRoom extends StatefulWidget {
  String hospitalId;
  String hospitalName;
  String paitientname;
  String paitientid;
  HospitalPastChatRoom({
    Key? key,
  ...
  @override
  State<HospitalPastChatRoom> createState() => _HospitalPastChatRoomState();
}

class _HospitalPastChatRoomState extends State<HospitalPastChatRoom> {
  String groupChatId = "";

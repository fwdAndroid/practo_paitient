...
class DoctorPastRoom extends StatefulWidget {
  String doctorId;
  String doctorName;
  String paitientname;
  String paitientid;
  ...
  @override
  State<DoctorPastRoom> createState() => _DoctorPastRoomState();
}

class _DoctorPastRoomState extends State<DoctorPastRoom> {
  String groupChatId = "";
